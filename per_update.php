...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	# initialize/validate (same as file: per_create.php)
    ...
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="per_update.php?id=<?php echo $id?>" method="post" enctype="multipart/form-data">
				...
				<!-- Form elements (same as file: per_create.php) -->
				...
				<div class="control-group">
					...
					<div class="controls">
						<select class="form-control" name="title">
							...
							if (0==strcmp($_SESSION['person_title'],'Student')) echo '<option selected value="Student" >Student</option>';
							else if($title==Student) echo 
							'<option selected value="Student" >Student</option><option value="Administrator" >Administrator</option>';
							else echo
