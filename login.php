...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if($data) { // if successful login set session variables
		...
		Database::disconnect();
		header("Location: persons.php?id=$sessionid ");
		// javascript below is necessary for system to work on github
		echo "<script type='text/javascript'> document.location = 'rented.php'; </script>";
		exit();
	}
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="login.php" method="post">
				...
				<div class="form-actions">
					...
					&nbsp; &nbsp;
					<a class="btn btn-primary" href="per_create.php">Join (New Students)</a>
